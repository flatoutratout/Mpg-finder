...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen flex flex-col font-inter bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      {/* Header */}
      ...
      {/* Footer */}
      <footer className="py-12 mt-20 text-center bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
