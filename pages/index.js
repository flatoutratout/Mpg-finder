...
export default function Home() {
  ...
  const jsonLd = {
    ...
    "@type": "ItemList",
    "name": "MPG Finder – Vehicle Fuel Economy Database",
    "description": "Compare fuel economy, CO₂ emissions, and performance data for thousands of cars.",
    "url": "https://www.mpgfinder.com",
    "numberOfItems": filteredData.length,
    "itemListElement": filteredData.slice(0, 20).map((v, index) => ({
      "@type": "ListItem",
      "position": index + 1,
      "url": `https://www.mpgfinder.com/cars/${makeSlug(v)}`,
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Find and compare vehicle MPG, CO₂ emissions, and performance data. Filter by make, model, and year to make informed eco-friendly driving choices." />
        <link rel="canonical" href="https://www.mpgfinder.com" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      </Head>

      <div className="min-h-screen bg-gradient-to-b from-blue-50 via-blue-100 to-blue-200">
        {/* Header */}
        <header className="sticky top-0 z-50 flex items-center justify-center p-6 shadow-md bg-blue-100">
          <div className="flex items-center space-x-4">
            <Image src="/logo.png" alt="MPG Finder Logo" width={200} height={200} />
            <h1 className="text-4xl font-extrabold text-blue-900">MPG Finder</h1>
          </div>
        </header>

        {/* Intro */}
        <section className="max-w-7xl mx-auto mt-6 p-6 shadow-xl rounded-xl bg-blue-50">
          <h2 className="text-2xl font-bold mb-4 text-blue-900">Welcome to MPG Finder</h2>
        ...
        <div className="max-w-7xl mx-auto mt-6 flex flex-wrap gap-4 items-center justify-center p-4">
          <div>
            <label htmlFor="makeFilter" className="block mb-1 text-blue-900">Make</label>
            <select
              id="makeFilter"
              value={makeFilter}
          ...
          <div>
            <label htmlFor="modelFilter" className="block mb-1 text-blue-900">Model</label>
            <select
              id="modelFilter"
              value={modelFilter}
          ...
          <div>
            <label htmlFor="yearFilter" className="block mb-1 text-blue-900">Year</label>
            <select
              id="yearFilter"
              value={yearFilter}
          ...
          <div className="flex-1 min-w-[200px]">
            <label htmlFor="searchInput" className="block mb-1 text-blue-900">Search</label>
            <input
              type="text"
              id="searchInput"
        ...
        {/* Data Table */}
        <main className="max-w-7xl mx-auto mt-6 p-6 shadow-xl rounded-xl bg-blue-50">
          <DataTable
            columns={columns}
            data={visibleData}
            pagination={false}
